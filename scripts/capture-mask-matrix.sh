...
MODEL_PATH="${1:-public/CubismSdkForNative/Samples/Resources/Mao/Mao.model3.json}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/target/render-regression/mask-matrix}"
...
capture_mode() {
  ...
  echo "Capturing ${model_name} mask ${label}"
